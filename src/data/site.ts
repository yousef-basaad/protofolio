...
export const site = {
  ...
  tagline: "I build clean, high-performance interfaces with React and Next.js.",
  description:
    "Front-End Developer specializing in React, Next.js and TypeScript, with experience building complete applications from design to deployment using Tailwind CSS and Supabase.",
